...
숫자 하나만 답변해주세요 (예: 2, -1, 0 등)."""
    ...
    def _build_prompt(self, user_message: str, context: str = None, username: str = "사용자", affection: int = 5, game_state: str = "ice_break", selected_subjects: list = None, subject_selected: bool = False, schedule_set: bool = False, official_mock_exam_grade_info: dict = None, subject_list_text: str = None):
        ...
        user_prompt = build_user_prompt(
            ...
            subject_list_text=subject_list_text
        )
    ...
    def generate_response(self, user_message: str, username: str = "사용자") -> dict:
        ...
        try:
            ...
            # 선택과목 목록 요청 시 프롬프트에 추가 (build_user_prompt 내부에서 처리)
            subject_list_text = None
            if new_state in ["icebreak", "mentoring"] and ("탐구과목" in user_message or "선택과목" in user_message or "과목 선택" in user_message or "과목 목록" in user_message):
                subject_list_text = self._get_subject_list_text()
