...
def get_career_description(career: str) -> str:
    ...
    descriptions = {
        # 의료 계열
        "의사": "환자를 치료하고 건강을 지키는 의료 전문가",
        "치과의사": "구강 건강을 관리하고 치료하는 의료 전문가",
        "한의사": "한의학적 방법으로 환자를 치료하는 전문가",
        "약사": "약물을 관리하고 복약 지도를 하는 전문가",
        "수의사": "동물의 건강을 관리하고 치료하는 전문가",
        "간호사": "환자를 돌보고 간병하는 의료 전문가",
        "물리치료사": "신체 재활을 도와주는 의료 전문가",
...
def get_career_related_subjects(career: str) -> list:
    ...
    career_subject_map = {
        # 의료 계열
        "의사": ["생명과학1", "생명과학2", "화학1", "화학2"],
        "치과의사": ["생명과학1", "생명과학2", "화학1"],
        "한의사": ["생명과학1", "생명과학2"],
        "약사": ["화학1", "화학2", "생명과학1"],
        "수의사": ["생명과학1", "생명과학2", "화학1"],
        "간호사": ["생명과학1", "생명과학2"],
